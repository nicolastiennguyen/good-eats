...
## Running Locally
Retrieve an API Key from https://www.yelp.com/developers/documentation/v3/get_started. Once on the website, navigate to: General > Create App > Login > Manage App > API Key. From there, locate the .env file in this repository and fill in the required inputs.
